...
$sql="select * from `forexinv_main` where invno='$invno'";
...
Mobile No.  +91 90812 96555,GSTIN.: 24BGGPC2142E1Z5,<br>Email: anshikashippingagency57@gmail.com</td>
				...
				<table>
					<tr>
						...
						<table >
							...
							<tr>
									<td colspan="2" style="width:145px;border-bottom:0px;text-align:left;font-size:12px;height:15px"><b>Country</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $country; ?></td>
								</tr>
							</table>
						</td>
		...
		<tr>
							...
							<table>
								...
								<?php 
								$srno=0;
								$sql="select * from `forexinv_child` where invno='$invno'";
								//echo $sql;
								//$tqty=0;
								//$total=0.00;
								//$cgst=0;
						...
						{ 
							...
							?>
											...
											<tr style="color:black;text-align:right;vertical-align:top;">
												...
												$code=$row['descript'];
												$query1 = mysqli_query($con,"SELECT pname FROM prod_master where code=$code");
												$results1 = mysqli_fetch_array($query1);
												$descript = $results1['pname'];
						...
						$igst=$igst+$row['iamt'];
							...
							$txamt=$cgst+$sgst+$igst;	?>
								...
								<tr>
									...
									<td style="border:0px;font-size:12px;" colspan="6"><b>Amount In Words :</b> &nbsp;&nbsp;<?php echo getIndianCurrency($gttl); ?></td>
								</tr>
									</table>
								</div>
							</td>
