...
$sql="select * from `credit_main` where crno='$crno'";
...
if(mysqli_query($con,$sql)){
	...
	$crno=$row['crno'];
	$crdt=$row['crdt'];
	if(($crdt=="")||($crdt=="0000-00-00")){$crdt="";}else{
										$crdt = date("d-m-Y", strtotime($crdt));}
										$invno=$row['invno'];
										$invdt=$row['invdt'];
										if(($invdt=="")||($invdt=="0000-00-00")){$invdt="";}else{
	...
	$bcode = $results['name']	;
										...
										$ship=$row['ship'];
											...
											$ackno=$row['ackno'];
											$ackdt=$row['ackdt'];
											if(($ackdt=="")||($ackdt=="0000-00-00")){$ackdt="";}
											else{
											$ackdt= date("d-m-Y",strtotime($ackdt));}
									}
  ...
  #table{
			...
			<td colspan="3">
				<table style="">
					...
					<tr>
						...
						<td colspan="2" style="width:247px;text-align:center;font-size:10px;"><span style="margin-left:30px;font-weight:bold;font-size:22px">CREDIT NOTE</span></td>
					...
					<tr>
						...
						<table>
							...
							<tr>
								...
								Plot No 17/18, Survey No 75/2, Nr HTPL CFS	<br>	
								Dhrab Road,Dhrab, Mundra-370421		<br>
								GSTIN/UN : 24AAHCN1060F1ZW		<br>
								State Name : Gujarat, Code : 24		<br>
								E-Mail: account.mundra@naishagroup.com		
								</td>
							</tr>
							</table>
						</td>
						...
						<table>
							<tr>
									<td  style="border:1px solid black;text-align:left;font-size:14px;width:230px;height:28px;">Credit Note No<br><?php echo $crno; ?></td>
									<td  style="border:1px solid black;text-align:left;font-size:14px;width:230px;height:28px;">Credit Note Date<br><?php echo $crdt; ?></td>
								</tr>
								<tr>
									<td  style="border:1px solid black;text-align:left;font-size:14px;width:230px;height:28px;">Against Invoice No<br><?php echo $invno; ?></td>
									<td  style="border:1px solid black;text-align:left;font-size:14px;width:230px;height:28px;">Invoice Date<br><?php echo $invdt; ?></td>
								</tr>
								<tr>
		...
		<tr>
							...
							<table  style="padding-top:15px">
								<tr>
									...
									<td style="width:250px;border:1px;text-align:center">Description of Goods</td>
									...
									<td style="width:100px;border:1px;text-align:center">Amount</td>
								</tr>
								<?php 
								$srno=0;
								$sql="select * from `cr_child` where crno='$crno'";
								//echo $sql;
								if(mysqli_query($con,$sql)){
						$data =mysqli_query($con,$sql);
	...
	<?php //echo numberTowords($total); ?>
					<tr>
						...
						<table>
							<tr>
								<td style="border:1px;width:175px;padding-top:10px">
								IRN No  : <?php echo wordwrap($irnno,30,"<br>\n",true); ?><br><br>
								ACK No   : <?php echo $ackno; ?><br>
								ACK Date : <?php echo $ackdt; ?><br>
								<img src="dist/img/QRImage.jpg" style="margin-top:20px;margin-left:35px;margin-right:30px;height:150px;width:150px">
								</td>
								<!--<td style="border:1px"><img src="dist/img/gpay.jpeg" style="margin-left:30px;margin-right:30px"><br><img src="dist/img/upi.png" style="margin-left:30px"></td>-->
								<td style="border:1px;text-align:right;width:230px"><br><br><br><br><br><br>Jagwani Shipping<br><br><br><br>Authorized Signatory</td>
							</tr>
							</table>
						</td>
	...
	<tr>
									<td colspan="2" style="font-size:11px;width:160px;font-weight:bold;text-align:center;padding-left:50px">This is Computer Generated Invoice.</td></tr>
	</table>
