...
<head>
  ...
  <title>Jagwani Shipping | Credit Note Entry</title>
...
<?php include('sidemenu.php'); ?>
  ...
  <div class="content-wrapper">
	...
	$cur_auto_id1 = $results['crno1'] + 1;		
				...
				$cur_auto_id1="NEPCRN/22-23/".$ad.$cur_auto_id1;
	  ...
	  ?>
                ...
                <div class="card-body">
					...
					<div class="row form-group">
						...
						<div class="col-12 col-md-4">
								     <input type="date" id="crdt" autofocus="autofocus" name="crdt" value="<?php if(isset($_GET['edit'])){echo $crdt;} ?>" class="form-control">
              ...
              <!-- /.card-body -->
				 ...
				 <!-----footer----->
								...
								<?php if($update=="true"): ?>
									 ...
									 <input type="submit"  class="btn btn-success " value="Save" name="send" />
...
$("#billinga").css("background-color","#17a2b8");
$("#entries").addClass("menu-open");
$("#entriesa").addClass("active");
$("#entriesa").css("background-color","#C0C0C0");	
