          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header" style="background-image: linear-gradient( 109.6deg,  rgba(177,248,146,1) 11.2%, rgba(81,152,11,1) 100.1% );">
                <h3 class="card-title">Bill Entry Search</h3>
			...
			if(isset($_POST['search'])){ $frmdt=$_POST['fromdate']; $todt=$_POST['todate'];$cust=$_POST['cust']; $billno=$_POST['billno']; }else{ $frmdt=""; $todt="";$cust="";$billno="";}
					 ...
					 $query = mysqli_query($con,"SELECT code FROM cust_master where name='$cust'");
									...
									$cust = $results['code']; 
					  $sql="SELECT * FROM `inv_main` WHERE 1=1";
						if($frmdt<>"" && $todt<>""){
					  ...
					  $tigst=0;
						...
						{ 
							...
							?>
											...
											<tr <?php if($invst=='Invoice Cancelled'){ echo "style='color:red;font-weight:bold'";}else{echo "style='color:black'";}?>>
												...
												<td><a href ="invoice-entry.php?edit=<?php echo $row['invno'];?>" <?php if($invst=='Invoice Cancelled'){echo "class='disabled'";} ?>><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Edit" <?php if($invst=='Invoice Cancelled'){echo "disabled";} ?>>
                                                            <i class="far fa-edit"></i>
									</button></a></td>
								<td><a href="invinput.php?delete=<?php echo $row['invno'];?>" <?php if($invst=='Invoice Cancelled'){echo "class='disabled'";} ?>><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Are you sure you want to delete this invoice?')" <?php if($invst=='Invoice Cancelled'){echo "disabled";} ?>>
                                                            <i class="far fa-trash-alt"></i>
									</button></a></td>
										<!--<td><a href=" invoiceprint.php?code=<?php echo $row['invno'];?>" <?php if($invst=='Invoice Cancelled'){echo "class='disabled'";} ?>><button class="btn btn-default btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Print" <?php if($invst=='Invoice Cancelled'){echo "disabled";} ?>>
