...
$sql="select * from `pinv_main` where invno='$invno'";
	...
	<table  id="table">
			...
			<td colspan="3">
				<table style="">
					...
					<tr>
						...
						<td colspan="2" style="width:247px;text-align:center;font-size:10px;"><span style="margin-left:30px;font-weight:bold;font-size:22px">PROFORMA INVOICE</span></td>
					...
					<tr>
						...
						<table>
							...
							<tr>
								...
								PLOT NO 94,WARD 9B-B,AKG SOCIETY, <br>Gandhidham,Kachchh, Gujarat, 370201	<br>	
						...
						<table>
								...
								<tr>
										...
										<td style="border:1px solid black;height:28px;font-size:14px;width:230px;text-align:left">Other Reference(s)<br><?php echo $oref; ?></td>		
								</tr>
					...
					<tr>
						...
						<table>
								...
								<tr>
									<td  style="border:1px solid black;text-align:left;font-size:14px;width:230px;height:28px;">Booking No/D.O No.<br><?php echo $bookno; ?></td>
		...
		<tr>
							...
							<table  style="padding-top:15px">
								...
								<?php 
								$srno=0;
								$sql="select * from `pinv_child` where invno='$invno'";
								//echo $sql;
								if(mysqli_query($con,$sql)){
						$data =mysqli_query($con,$sql);
					...
					<tr>
						...
						<table>
							<!-- <tr>
								...
								<td style="border:1px;text-align:right;width:230px"><br>Jagwani Shipping<br><br><br><br>Authorized Signatory</td>
							</tr> -->
							</table>
						</td>
