...
$sql="select * from `inventry` where invno='$invno'";
...
if(mysqli_query($con,$sql)){
						...
						$row = mysqli_fetch_array($data);
										...
										$billto=$row['billto'];
										$query = mysqli_query($con,"SELECT * FROM party_mst where code='$billto'");
										...
										$badrs=$results['adrs'];
										$shipto=$row['shipto'];
										$query2 = mysqli_query($con,"SELECT * FROM party_mst where code='$shipto'");
...
Mobile No.  +91 90812 96555,GSTIN.: 24BGGPC2142E1Z5,<br>Email: anshikashippingagency57@gmail.com</td>
					...
					<tr>
						<td style="width:150px;padding-bottom:8px;margin-bottom:0px" valign="top"><img src="jsimg/jslogo.png" style="height:140px;width:200px;"></td>
						...
						<td  style="width:360px;padding-left:0px;margin-bottom:0px;padding-top:5px;font-size:15px;font-weight:bold;text-align:center;"><span style="font-weight:bold;font-size:17px;color:black;text-align:center;">JAGWANI SHIPPING PRIVATE LIMITED</span><br><span style="font-weight:normal;font-size:11px;color:black;margin-top:5px;text-align:center;"> Plot No 592 Ward 12C, Office No 2, 2nd Floor, Ganesh Building, Lilashah Circle, Old Police Station near, Ward 12C, Gandhidham,Kachchh, Gujarat, 370201.<br><b>Mobile No.</b>  +91 90812 96555,<br><b>Email:</b> anshikashippingagency57@gmail.com</span><br><span style="font-weight:bold;font-size:13px;color:black;margin-top:15px">TAX INVOICE<br>(Original For Recepient)</span></td>
				...
				<table>
					<tr>
						<td style="width:350px;border:1px">
							...
							<tr>
								...
								<tr>
									<td colspan="3" style="border-bottom:0px;text-align:left;font-size:12px;width:220px;height:15px;"><b>SB/BE No </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $beno; ?></td></tr>
							
								<tr>
									<td colspan="3" style="border-bottom:0px;text-align:left;font-size:12px;width:220px;height:15px;"><b>SB/BE Dt </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo date('d-m-Y',strtotime($bedt)); ?></td></tr>
								<tr>
									<td colspan="3" style="border-bottom:0px;text-align:left;font-size:12px;width:220px;height:15px;"><b>BL No </b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $blno; ?></td></tr>
							<tr>
									<td colspan="3" style="border-bottom:0px;text-align:left;font-size:12px;width:220px;height:15px;"><b>Commodity </b>&nbsp;&nbsp;: <?php echo wordwrap($commodity,"60","<br>\n"); ?></td>
								</tr>
								<tr>
								<td colspan="3" style="width:230px;height:15px;text-align:left;font-size:12px;"><b>POL </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $pol; ?></td>
						...
						<table >
							...
							<tr>
									<td colspan="2"  style="border-bottom:0px;text-align:left;font-size:12px;width:335px;height:5px;"><b>POD </b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $pod; ?></td></tr>
									<tr>
									<td colspan="2" style="border-bottom:0px;text-align:left;font-size:12px;width:350px;height:15px;"><b>Final Destination </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $dest; ?></td>
									</tr>
								<tr>
									<td colspan="2" style="border-bottom:0px;text-align:left;font-size:12px;width:230px;height:15px;"><b>Shipping Line </b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $line; ?></td></tr>
							<tr>
								
									<td colspan="2" style="border-bottom:0px;border-right:0px;text-align:left;font-size:12px;width:150px;height:15px;"><b>Grs Wt </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $grswt; ?></td></tr>
							<tr>
									<td colspan="2" style="width:145px;border-bottom:0px;text-align:left;font-size:12px;height:15px"><b>Net Wt </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $netwt; ?></td>
								</tr>
								<tr>
									<td colspan="2" style="width:200px;height:25px;text-align:left;font-size:12px;"><b>No Of Containers </b>&nbsp;&nbsp;&nbsp;&nbsp;: <?php echo $contno; ?></td>
					...
					<tr>
						<td colspan="2" style="width:650px;border:1px;"><b>Container Details :</b>&nbsp;&nbsp;&nbsp;<?php echo wordwrap($cdtl,92,"<br>\n"); ?></td>
					</tr>
					<tr>
		...
		<tr>
							...
							<table>
								<tr>
									...
									<td style="width:300px;border:1px;text-align:center;font-weight:bold;padding-top:7px;font-size:12px;">Perticular</td>
									<td style="width:90px;border:1px;text-align:center;font-weight:bold;padding-top:7px;font-size:12px;">HSN/SAC</td>
									<td style="width:77px;border:1px;text-align:center;font-weight:bold;padding-top:7px;font-size:12px;">Qty</td>
									<td style="width:77px;border:1px;text-align:center;font-weight:bold;padding-top:7px;font-size:12px;">Rate</td>
									<td style="width:110px;border:1px;text-align:center;font-weight:bold;padding-top:7px;font-size:12px;">Amount</td>
								</tr>
								<?php 
								$srno=0;
								$sql="select * from `invchild` where invno='$invno'";
								//echo $sql;
								$tqty=0;
								$total=0.00;
								$cgst=0;
						...
						{ 
							...
							?>
											...
											<tr style="color:black;text-align:right;vertical-align:top;">
												...
												$descript=$row['desc'];
												$query1 = mysqli_query($con,"SELECT chrg FROM chmst where code=$descript");
												...
												<td style="color:black;border:1px;text-align:center"><?php echo $row['total']; ?></td>
						...
						$igst=$igst+$row['iamt'];
							...
							$txamt=$cgst+$sgst+$igst;	?>
								...
								<tr>
									...
									<td style="border:1px;font-size:12px;" colspan="6"><b>Amount In Words :</b> &nbsp;&nbsp;<?php echo getIndianCurrency($gttl); ?></td>
								</tr>
									</table>
								</div>
							</td>
	...
	<?php //echo numberTowords($total); ?>
					<tr>
						...
						<table>
							<tr>
								<td style="border:1px;border-top:none;width:250px;text-align:center;height:15px">Total Amount Before Tax</td>
								<td style="border:1px;border-top:none;text-align:center;width:100px"><?php echo $total; ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="border:1px;width:250px"></td>
								<td style="border:1px;text-align:center;width:100px"><?php echo $txamt; ?></td>
							</tr>
							
							<tr>
								<td style="border:1px;width:250px;height:15px">Total Amount After Tax</td>
								<td style="border:1px;text-align:center;width:100px"><?php echo $gttl; ?></td>
							</tr>
							<tr>
