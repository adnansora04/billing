          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header" style="background-image: linear-gradient( 109.6deg,  rgba(177,248,146,1) 11.2%, rgba(81,152,11,1) 100.1% );">
                <h3 class="card-title"style="black">Credit Note Entry</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" id="formfield" action="credinput.php">
				  <?php
											include('config.php');
					$query = mysqli_query($con,"SELECT MAX( cast( substr(crno,14,3) as decimal)) as crno1 FROM credit_main");
	$results = mysqli_fetch_array($query);
	$cur_auto_id1 = $results['crno1'] + 1;		
				...
				$cur_auto_id1="EMSCRN/23-24/".$ad.$cur_auto_id1;
...
$update= false;
	...
	$code=$_GET['edit'];
					//echo $code;
	$update= true;
	$qry="SELECT * FROM `credit_main` WHERE `crno` = '$code'";
					//echo $qry;
	...
	$bcode = $results['name']	;
		$irnno=$row['irnno'];
			...
			if($irnno==''){
				$sql2="select * from einv2 where inv='$code'";
				//echo $sql2;
                ...
                <div class="card-body">
					<div class="row form-group">
                                <div class="col col-md-3">
                                 <label for="hf-password" class=" form-control-label">Credit Note No</label>
									</div>
								<div class="col-12 col-md-4">
										<input type="text" id="crno" name="crno" value="<?php if(isset($_GET['edit'])){ echo $crno;} else{ echo $cur_auto_id1;} ?>" placeholder="code" class="form-control" readonly>
                            	</div>
					...
					<div class="row form-group">
                              <div class="col col-md-3">
                                 <label for="hf-password" class=" form-control-label">Credit Note Date</label>
						</div>
						<div class="col-12 col-md-4">
								     <input type="date" id="crdt" autofocus="autofocus" name="crdt" value="<?php if(isset($_GET['edit'])){echo $crdt;}else{echo $currentTime;} ?>" class="form-control">
                                                    
                           </div>
                        </div>
					<div class="row form-group">
                                <div class="col col-md-3">
                                   <label for="hf-password" class=" form-control-label">Against Invoice No</label>
							</div>
							<div class="col-12 col-md-4">
                                     		 <select  class="select2"   id="invno" name="invno" style="width:100%">
													<?php if(isset($_GET['edit'])){ ?> <option><?php echo $invno; ?></option><?php } ?>
                    									<option value="">~~SELECT~~</option>
													 		<?php
                     											include('config.php');
                       											$res= mysqli_query($con,"select distinct invno from inv_main order by invno asc");
															?>
						...
						<div>
							<input type="button" name="load" id="load" value="Load" class="form-control">
						</div>
						</div>
					<div class="row form-group">
                              <div class="col col-md-3">
                                 <label for="hf-password" class=" form-control-label">Invoice Date</label>
						</div>
						<div class="col-12 col-md-4">
								     <input type="date" id="invdt" autofocus="autofocus" name="invdt" value="<?php if(isset($_GET['edit'])){echo $invdt;} ?>" class="form-control">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>	
                    ...
                    <tr>
                      <td>1.</td>
						...
						if($update=="true"){
							...
							$sql=mysqli_query($con,"select * from `cr_child` where crno='$crno'");
							$i=0;
                     ...
                     <td style="width:90px"><input type="text" tabindex='-1' name="hsn1" id="hsn1" value="<?php echo $hsn1; ?>" style="border:none;width:70px;text-align:center;margin-left:60px"> </td>
                    ...
                    <tr>
                     ...
                     <td style="width:90px"><input type="text" tabindex='-1' name="hsn2" id="hsn2" style="border:none;width:70px;text-align:center;margin-left:60px" value="<?php echo $hsn2; ?>"> </td>
                      <td><input type="text" name="qty2" id="qty2" style="border:none;width:50px;text-align:center" value="<?php echo $qty2; ?>"> </td>
						...
						<td><input type="text" name="gstrate2" tabindex='-1' id="gstrate2" style="border:none;width:50px;text-align:right" value="<?php $gstrate2; ?>"> </td>
                    ...
                    <tr>
                      ...
                      <td style="width:90px"><input type="text" tabindex='-1' name="hsn3" id="hsn3" style="border:none;width:70px;text-align:center;margin-left:60px" value="<?php echo $hsn3; ?>">  </td>
                    ...
                    <tr>
                      ...
                      <td style="width:90px"><input type="text" tabindex='-1' name="hsn4" id="hsn4" style="border:none;width:70px;text-align:center;margin-left:60px" value="<?php echo $hsn4; ?>">  </td>
                      ...
                      <td style="width:90px"><input type="text" name="hsn5" tabindex='-1' id="hsn5" style="border:none;width:70px;text-align:center;margin-left:60px" value="<?php echo $hsn5; ?>">  </td>
					  ...
					  <td><input type="text" tabindex='-1' name="cgst" id="cgst" value="<?php echo $cper; ?>" style="border:none;text-align:right"> </td>
                      <td></td>
						  <td></td>
						<td></td>
						<td></td>
					  ...
					  <td><input type="text" tabindex='-1' name="sgst" id="sgst" value="<?php echo $sper; ?>" style="border:none;text-align:right"> </td>
                      <td></td>
						<td></td>
						  <td></td>
						<td></td>
					  ...
					  <td><input type="text" tabindex='-1' name="igst" id="igst" value="<?php echo $iper; ?>" style="border:none;text-align:right">  </td>
                      <td></td>
						  <td></td>
						<td></td>
						<td></td>
					  ...
					  <td><input type="text" tabindex='-1' name="total" id="total"  style="border:none;text-align:right">  </td>
                      <td></td>
						<td></td>
						<td></td>
						  <td></td>
              ...
              <!-- /.card-body -->
				 ...
				 <!-----footer----->
								...
								<?php if($update=="true"): ?>
									 ...
									 <input type="submit"  class="btn btn-success " value="Save" id="submit" name="send" />
                  <!--<button type="submit" name="send" value="Save" id="submitBtn" class="btn btn-success">Save</button>-->
									<?php endif; ?>
...
<!-- ./wrapper -->
	...
	$('#formfield').attr('action','gjson2.php');
    $('#formfield').submit();
});    
	$('#girn').click(function(){
	...
	$('#einv').click(function(){
	alert('Updating');
	$('#formfield').attr('action','girn2.php');
    $('#formfield').submit();
...
<script>
	...
	$.ajax({
            ...
            success: function(response)          // recieved data from generateno.php
	{
				var len = response.length;
		
            for(var i=0; i<len; i++){
                var invdt = response[i].invdt;
				var billto =response[i].billto;
				var delnote = response[i].delnote;
				var mode = response[i].mode;
				var ship = response[i].ship;
				var oref = response[i].oref;
				var bookno= response[i].bookno;
				var bookdt=response[i].bdt;
				var disp=response[i].disp;
				var dest=response[i].dest;
				var delterms=response[i].delterms;
				var cgst=response[i].cgst;
				var sgst=response[i].sgst;
				var igst=response[i].igst;
				var round=response[i].round;
				var total=response[i].total;
				var txamt=response[i].txamt;
				var cper=response[i].cper;
				var sper=response[i].sper;
				var iper=response[i].iper;
				if(i==0){
				document.getElementById('invdt').value=invdt;
				$('#billto').val(billto).trigger('change');
				document.getElementById('del').value=delnote;
				$('#mode').val(mode).trigger('change');
				document.getElementById('ship').value=ship;
				document.getElementById('oref').value=oref;
				document.getElementById('bookno').value=bookno;
				document.getElementById('bookdt').value=bookdt;
				document.getElementById('disp').value=disp;
				document.getElementById('dest').value=dest;
				document.getElementById('dterms').value=delterms;
				document.getElementById('tcgst').value=cgst;
				document.getElementById('tsgst').value=sgst;
				document.getElementById('tigst').value=igst;
				document.getElementById('roundoff').value=round;
				document.getElementById('tamt').value=total;
				document.getElementById('ttl').value=txamt;
				document.getElementById('cgst').value=cper;
				document.getElementById('sgst').value=sper;
				document.getElementById('igst').value=iper;	
				}	
...
$.ajax({
            ...
            success: function(response)          // recieved data from generateno.php
	{
            ...
            for(var i=0; i<len; i++){
				...
				var gstrate = response[i].gstrate;
				var gstamount = response[i].gstamount;
				var amount = response[i].amount;
				
				if(i==0){
				$('#desc1').val(desc).trigger('change');
				document.getElementById('hsn1').value=hsn;
				document.getElementById('qty1').value=qty;
				document.getElementById('rate1').value=rate;
				document.getElementById('gstrate1').value=gstrate;
				document.getElementById('gstamt1').value=gstamount;
				document.getElementById('amt1').value=amount;
				}	
				if(i==1){
				$('#desc2').val(desc).trigger('change');
				document.getElementById('hsn2').value=hsn;
				document.getElementById('qty2').value=qty;
				document.getElementById('rate2').value=rate;
				document.getElementById('gstrate2').value=gstrate;
				document.getElementById('gstamt2').value=gstamount;
				document.getElementById('amt2').value=amount;
				}
				if(i==2){
				$('#desc3').val(desc).trigger('change');
				document.getElementById('hsn3').value=hsn;
				document.getElementById('qty3').value=qty;
				document.getElementById('rate3').value=rate;
				document.getElementById('gstrate3').value=gstrate;
				document.getElementById('gstamt3').value=gstamount;
				document.getElementById('amt3').value=amount;
				}
				if(i==3){
				$('#desc4').val(desc).trigger('change');
				document.getElementById('hsn4').value=hsn;
				document.getElementById('qty4').value=qty;
				document.getElementById('rate4').value=rate;
				document.getElementById('gstrate4').value=gstrate;
				document.getElementById('gstamt4').value=gstamount;
				document.getElementById('amt4').value=amount;
				}				
				if(i==4){
				$('#desc5').val(desc).trigger('change');
				document.getElementById('hsn5').value=hsn;
				document.getElementById('qty5').value=qty;
				document.getElementById('rate5').value=rate;
				document.getElementById('gstrate5').value=gstrate;
				document.getElementById('gstamt5').value=gstamount;
				document.getElementById('amt5').value=amount;
				}				
...
$("#crentry").addClass("active");
$("#crentry").css("background-color","F0F0F0");
});
